...
public class horizontalRecycleViewAdapter extends RecyclerView.Adapter<horizontalRecycleViewAdapter.MyViewHolder>{
    ...
    public horizontalRecycleViewAdapter(Context context,int postNewUserIcon[],String postNewuserName[],String postNewsTime[],int plusicon[]){
    ...
    public horizontalRecycleViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.post_informantion_layout,viewGroup,false);

        return new horizontalRecycleViewAdapter.MyViewHolder(itemView);
